...
//
//    private val backStack = mutableListOf<NavKey>(Splash)
//
//    @Before
//    fun setupAppNavHost() {
...
//        assertTrue(backStack.contains(Splash))
//    }
//
//
//    @Test
...
//            true
//        }
//        assertTrue(backStack.contains(CalendarScreen))
//
//        composeTestRule.onNodeWithTag(CALENDAR_CONTENT).assertIsDisplayed()
//
//    }
//
//
...
//
//        composeTestRule.onNodeWithText(CHEAT_BUTTON).performClick()
//        composeTestRule.onNodeWithText("Cheat Meals").assertIsDisplayed()
//    }
////
////
////    @Test
...
////        assertTrue(navController.currentBackStackEntry?.destination?.hasRoute<CalendarScreen>() ?: false)
////    }
////
////
////    @Test
