...
import com.example.fitness_routine.presentation.ui.icons.MyIconPack

public val MyIconPack.Google: ImageVector
    get() {
        if (_google != null) {
            return _google!!
        }
        _google = Builder(name = "Google", defaultWidth = 48.0.dp, defaultHeight = 48.0.dp,
